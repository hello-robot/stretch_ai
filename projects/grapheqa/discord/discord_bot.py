...
class GraphEQADiscordBot(DiscordBot):
    ...
    def add_robot_QA(self, response: List[Tuple[str, str]], channel: discord.TextChannel):
        ...
        with self._plan_lock:
            self.next_question = response, channel

    def plan_thread(self):
        """Loop. Check to see if next plan received. If so, execute it. Else, sleep. After execution, set next_question to None."""
