...
class RerunVsualizer:
    ...
    def log_head_camera(self,obs):
            ...
            rr.log("world/head_camera/depth", rr.DepthImage(obs["depth"], meter=1000.0, colormap="viridis"))
            rr.log(
    ...
    def log_robot_xyt(self, obs):
            ...
            xy = obs['gps']
            theta = obs['compass']
            rb_arrow = rr.Arrows3D(origins=[0, 0, 0], vectors=[1, 0, 0], radii=0.02, labels="robot", colors=[255, 0, 0, 255])
    ...
    def log_ee_frame(self, servo):
            ...
            ee_arrow = rr.Arrows3D(origins=[0, 0, 0], vectors=[1, 0, 0], radii=0.02, labels="ee", colors=[0, 255, 0, 255])
    ...
    def log_ee_camera(self, servo):
        ...
        rr.log("world/ee_camera/depth", rr.DepthImage(servo.ee_depth, meter=1000.0, colormap="viridis"))
        rr.log(
            "world/ee_camera/img",
            rr.Pinhole(
        ...
        rot,trans= decompose_homogeneous_matrix(servo.ee_camera_pose)
        rr.log("world/ee_camera", rr.Transform3D(translation=trans, mat3x3=rot))
