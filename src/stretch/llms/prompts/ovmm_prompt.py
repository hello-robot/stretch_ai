...
You can use clean() to clean up floor surface within 3 meters.

input: "Clean up the floor."
output:
say("I am cleaning up the floor")
clean()
end()
...
class OVMMPromptBuilder(AbstractPromptBuilder):
    def __init__(self):
